...
def get_obj_from_str(string, reload=False):
    ...
    try:
        # Try to import with the correct package name
        obj = getattr(importlib.import_module(module, package="ComfyUI-Hunyuan3DWrapper"), cls)
    except:
        try:
            # Fallback to direct import
            obj = getattr(importlib.import_module(module), cls)
        except:
            # Last fallback with relative path
